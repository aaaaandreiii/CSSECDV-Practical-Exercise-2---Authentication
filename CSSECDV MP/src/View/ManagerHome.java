...
/** Manager home panel with top guard. */
public class ManagerHome extends JPanel {
    private final JLabel lbl = new JLabel("Manager Home");
    ...
    public ManagerHome() {
        ...
        add(btnGoLogin, BorderLayout.SOUTH);

        btnGoLogin.addActionListener(e -> {
            java.awt.Window w = SwingUtilities.getWindowAncestor(this);
            if (w instanceof Frame) ((Frame) w).logout();
        });
    }
    ...
    public void addNotify() {
        ...
        if (w instanceof Frame) {
            Frame f = (Frame) w;
            Frame.Session s = f.getSession();
            if (s == null || s.isExpired(20L * 60L * 1000L) ||
                s.user == null || s.user.getRole() != Frame.ROLE_MANAGER) {
                f.logout(); // fail closed
            } else {
                s.touch();
            }
        }
